...
@section('content')
  <div class="container-fluid">
		<div class="page-header">
			<h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Administración <small>NUEVO PRESTAMO</small></h1>
		</div>
		<p class="lead"></p>
	</div>
	...
	<div class="container-fluid">
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; NUEVO PRESTAMO</h3>
			</div>
                      ...
                      @endforeach
				    		...
				    		<div class="col-xs-12 col-sm-6">
								  <div class="form-group label-floating">
										...
										<input  class="form-control" type="date" name="fecha_prestamo" required>
									</div>
				    		</div>
				    		<div class="col-xs-12 col-sm-6">
								  <div class="form-group label-floating">
				    		...
				    		<div class="col-xs-12 col-sm-6">
								  <div class="form-group label-floating">
										...
										<input  class="form-control" type="text" name="renovaciones" required>
									</div>
				    		</div>
				    	</div>
						</div>
